...
<fieldset class="scheduler-border">
    <legend class="scheduler-border">Translator</legend>
    <form method="post" action="/index">
        <div class="form-group">
            <label >English Word </label>
            <input type="text" class="form-control" name="english" id="rate" placeholder="Input Exchange Rate" value="${english}">
        </div>
        <div class="form-group">
            <label >VietNam Word</label>
            <input type="text" class="form-control" name="vnd" id="usd" placeholder="Input Usd" value="${vnd}">
        </div>
        <div class="form-group">
            <label >Status</label>
            <p>${status}</p>
        ...
        <div class="form-group row">
            <div class="offset-sm-2 col-sm-7 pull-right">
                <button type="submit" class="btn btn-primary">Transalte</button>
            </div>
        </div>
    </form>
</fieldset>
